...
7. Go to "File" > "Export Packet Dissections", select "As CSV..." and save the CSV file as "task1"
...
1. Download and open the following Excel file
...
- GeoLite2-Country
- GeoLite2-City 
The GeoLite2 data contained in the files is created by MaxMind and available from
